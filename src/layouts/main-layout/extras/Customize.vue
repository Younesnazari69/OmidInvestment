<template>
  <div class="engage-toolbar d-flex position-fixed px-5 fw-bold zindex-2 top-50 end-0 transform-90 mt-50 gap-2">
    <button id="kt_app_layout_builder_toggle"
      ...
      title="تنظیمات" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
      <KTIcon icon-name="setting-4" icon-class="fs-4 me-1" />تنظیمات
    </button>
  </div>
    ...
    <div class="card border-0 shadow-none rounded-0 w-100">
      ...
      <div class="card-body position-relative" id="kt_app_layout_builder_body">
        ...
        <div id="kt_app_settings_content" class="position-relative scroll-y me-n5 pe-5" data-kt-scroll="true"
          ...
          data-kt-scroll-offset="5px" style="height: 710px">
          <!--begin::Form-->
            ...
            <div class="card-body p-0">
                ...
                <div class="row" data-kt-buttons="true" data-kt-buttons-target=".form-check-image,.form-check-input"
                  ...
                  <div class="col-6">
                    ...
                    <label :class="[themeMode === 'light' && 'active']" class="form-check-image form-check-success">
                      ...
                      <div class="form-check form-check-custom form-check-solid form-check-sm form-check-success">
                        <input :checked="themeMode === 'light'" @change="onThemeModeChange" class="form-check-input"
                  ...
                  <div class="col-6">
                    ...
                    <label :class="[themeMode === 'dark' && 'active']" class="form-check-image form-check-success">
                      ...
                      <!--begin::Check-->
                      <div class="form-check form-check-custom form-check-solid form-check-sm form-check-success">
                        <input @change="onThemeModeChange" :checked="themeMode === 'dark'" class="form-check-input"
              ...
              <div class="form-group">
                ...
                <div class="d-flex flex-stack gap-3">
                  ...
                  <label :class="config.general.iconsType === 'duotone' && 'active'"
                    ...
                    <div style="
                      ...
                      <input v-model="config.general.iconsType" class="form-check-input" type="radio" value="duotone"
                        :checked="config.general.iconsType === 'duotone'" name="duotone" />
                    </div>
                    <!--end::Check-->
                  </label>
                  <!--end::Option-->
                  ...
                  <label :class="config.general.iconsType === 'outline' && 'active'"
                    ...
                    <!--begin::Image-->
                    <div class="form-check-wrapper d-flex flex-center border-gray-200 border-2 mb-0 py-3 px-4">
                      <KTIcon icon-type="outline" icon-name="picture"
                        icon-class="fs-1 text-gray-500 parent-active-gray-700 parent-hover-gray-700" />
                      <span
                  ...
                  <label :class="config.general.iconsType === 'solid' && 'active'"
                    ...
                    <!--begin::Image-->
                    <div class="form-check-wrapper d-flex flex-center border-gray-200 border-2 mb-0 py-3 px-4">
                      <KTIcon icon-type="solid" icon-name="picture"
                        icon-class="fs-1 text-gray-500 parent-active-gray-700 parent-hover-gray-700" />
                      <span
              ...
              <div class="form-group">
                ...
                <div class="d-flex">
                  <!--begin::Check-->
                  <div class="form-check form-check-custom form-check-success form-check-solid form-check-sm me-5">
                    <input v-model="config.sidebar.default.menu.iconType" class="form-check-input" type="radio"
                      value="keenthemes" id="kt_builder_keenthemes_icons" />
                    <!--begin::Label-->
                    <label class="form-check-label text-gray-700 fw-bold text-nowrap"
                      for="kt_builder_keenthemes_icons">Keenthemes Icons</label>
                    <!--end::Label-->
                  </div>
                  <!--end::Check-->
                  <!--begin::Check-->
                  <div class="form-check form-check-custom form-check-success form-check-solid form-check-sm me-5">
                    <input v-model="config.sidebar.default.menu.iconType" class="form-check-input" type="radio"
                      value="bootstrap" id="kt_builder_bootstrap_icons" />
                    <!--begin::Label-->
                    <label class="form-check-label text-gray-700 fw-bold text-nowrap"
                      for="kt_builder_bootstrap_icons">Bootstrap Icons</label>
                    <!--end::Label-->
                  </div>
                  <!--end::Check-->
                </div>
                ...
                <div class="row gy-3" data-kt-buttons="true"
                  ...
                  <div class="col-6">
                    ...
                    <label class="form-check-image form-check-success"
                      ...
                      <!--begin::Image-->
                      <div class="form-check-wrapper">
                        <img :src="getAssetPath('media/misc/layout/dark-sidebar.png')
                          " class="mw-100" alt="" />
                      </div>
                      <!--end::Image-->
                      <!--begin::Check-->
                  ...
                  <div class="col-6">
                    ...
                    <label class="form-check-image form-check-success"
                      ...
                      <!--begin::Image-->
                      <div class="form-check-wrapper">
                        <img :src="getAssetPath('media/misc/layout/light-sidebar.png')
                          " class="mw-100" alt="" />
                      </div>
                      <!--end::Image-->
                      <!--begin::Check-->
                  ...
                  <div class="col-6">
                    ...
                    <label class="form-check-image form-check-success"
                      ...
                      <!--begin::Image-->
                      <div class="form-check-wrapper">
                        <img :src="getAssetPath('media/misc/layout/dark-header.png')
                          " class="mw-100" alt="" />
                      </div>
                      <!--end::Image-->
                      <!--begin::Check-->
                  ...
                  <div class="col-6">
                    ...
                    <label class="form-check-image form-check-success"
                      ...
                      <!--begin::Image-->
                      <div class="form-check-wrapper">
                        <img :src="getAssetPath('media/misc/layout/light-header.png')
                          " class="mw-100" alt="" />
                      </div>
                      <!--end::Image-->
                      <!--begin::Check-->
      ...
      <div class="card-footer border-0 d-flex gap-3 pb-9 pt-0" id="kt_app_layout_builder_footer">
        <button type="button" @click="submit" id="kt_app_layout_builder_preview"
          class="btn btn-primary flex-grow-1 fw-semibold">
          <!--begin::Indicator label-->
          <span class="indicator-label">Preview</span>
          <!--end::Indicator label-->
        </button>
        <button @click="reset" type="button" id="kt_app_layout_builder_reset"
