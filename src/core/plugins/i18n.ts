...
const messages = {
  en: {
    dashboard: "داشبورد",
    layoutBuilder: "تنظیمات",
    BaseInfo: "اطلاعات پایه",
    OccasionTypes: "انواع پست های مناسبتی",
    OccasionTypeList: "لیست",
    OccasionTypeNew: "جدید",
    OccasionImages: "تصاویر پست های مناسبتی",
    OccasionImageList: "لیست",
    OccasionImageNew: "جدید",
    Posts: "پست ها",
    PostList: "لیست",
