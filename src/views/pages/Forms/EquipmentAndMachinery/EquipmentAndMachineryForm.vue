        ...
        <div class="card-body">
          ...
          <div class="row fv-row mb-7">
            ...
            <div class="col-xl-4">
              ...
              <Field class="form-control form-control-sm form-control-solid" type="text" placeholder="" name="inspection"
                autocomplete="off" />
              <div class="fv-plugins-message-container">
                <div class="fv-help-block">
            ...
            <div class="col-xl-4">
              ...
              <input class="form-control form-control-sm form-control-solid" type="file" @change="StatementOfAssetsFiles"
                multiple="true" />
            </div>
            <div class="col-xl-4">
              <label class="form-label fw-bold text-dark fs-6">کد محل استقرار ، مرکز هزینه ، کد مرکز هزینه</label>
              <input class="form-control form-control-sm form-control-solid" type="file" @change="LocationCodeFiles"
                multiple="true" />
            </div>
            <div class="col-xl-4">
            ...
            <div class="col-xl-4">
              <label class="form-label fw-bold text-dark fs-6">سایر فایل ها</label>
              <input class="form-control form-control-sm form-control-solid" type="file" @change="ImageOfAllBillsFiles"
                multiple="true" />
            </div>
            <!-- <img :src="UploudFile"> -->
