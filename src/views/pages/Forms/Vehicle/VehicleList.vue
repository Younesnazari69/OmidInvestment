    ...
    <div class="card-body">
      ...
      <div class="row fv-row mb-7">
        ...
        <template v-for="(searchFields, index) in filter.searchFields">
          ...
          <div v-if="searchFields.value == 'VehicleType'" class="col-xl-3">
            ...
            <div class="row">
              <div class="col-xl-2">
                <select class="form-control form-control-sm form-control-solid" name="V-Oparation"
                  v-model="filter.searchValue.VehicleType.oparation">
              ...
              <div class="col-xl-10">
                <input class="form-control form-control-sm form-control-solid" type="text" placeholder=""
                  name="VehicleType" v-model="filter.searchValue.VehicleType.value" autocomplete="off" />
              </div>
            </div>
          </div>
          ...
          <div v-if="searchFields.value == 'PoliceLicensePlate'" class="col-xl-3">
            <label class="form-label fw-bold text-dark fs-6">پلاک انتظامی</label>
            <div class="row">
              <div class="col-xl-2">
                <select class="form-control form-control-sm form-control-solid" name="P-Oparation"
                  v-model="filter.searchValue.PoliceLicensePlate.oparation">
                  <option value="in">in</option>
                  <option value="="> = </option>
                  <option value="!="> != </option>
                </select>
              ...
              <div class="col-xl-10">
                <input class="form-control form-control-sm form-control-solid" type="text" placeholder=""
                  name="PoliceLicensePlate" v-model="filter.searchValue.PoliceLicensePlate.value" autocomplete="off" />
              </div>
            </div>
          </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const DefaultsearchValue = {
      ...
      VehicleType: { value: '', key: 0, oparation: '' },
      OwnerName: { value: '', key: 0, oparation: '' },
      PoliceLicensePlate: { value: '', key: 0, oparation: '' },
    ...
    const FechData = async (ResultType:string) => {
      ...
      loading.value = true;
      return store.FechVehicles(serverOptions.value,filter,ResultType).then(() => {
        items.value = store.VehiclesData.List;
        serverItemsLength.value = store.VehiclesData.serverTotalItemsLength;
        if (store.VehiclesData.exportToExcellFileUrl != "") {
          downloadFile(store.VehiclesData.exportToExcellFileUrl)
        }
        loading.value = false;
      });
    };
